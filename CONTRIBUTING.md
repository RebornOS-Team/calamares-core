...
- [ ] Create and push a tag, for example `git tag -a v3.3.14_005 -m "This is version v3.3.14_005" && git push origin v3.3.14_005`
- [ ] If there was a mistake and if you want to yank the release, run something like `git tag -d v3.3.14_005 && git push --delete origin v3.3.14_005`. Then the errors can be fixed and the previous step can be repeated to create a new tag.
